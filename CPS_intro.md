...
Cyber-physical systems bring computation into direct interaction with the physical world. A cyber-physical system, or **CPS**, contains physical and engineered processes whose operations are monitored, coordinated, controlled, or integrated by computational and communication components.

Examples include autonomous vehicles, industrial robots, medical devices, smart buildings, power systems, and transportation networks. Although these systems operate in very different environments, they share a common structure: computation receives information about a physical process, makes decisions, and produces actions that affect the subsequent behaviour of that process.

This continuous interaction between information and physical behaviour is the central idea of cyber-physical systems.
